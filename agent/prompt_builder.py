...
MEMORY_GUIDANCE = (
    ...
    "logs, or temporary TODO state to baseline memory. Put operational details in docs, "
    "registries, or skills unless they are compact facts that will change decisions constantly. "
