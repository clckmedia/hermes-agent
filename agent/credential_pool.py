        ...
        try:
            ...
            if self.provider == "anthropic" and entry.source == "claude_code":
                ...
                if synced.refresh_token != entry.refresh_token:
                    ...
                    return synced
            # For openai-codex: another Hermes process may have consumed the
            # refresh token between our proactive sync and the HTTP call.
            # Re-check auth.json and adopt fresh tokens if they rotated.
            if self.provider == "openai-codex":
                ...
                # remove device-code-sourced entries from the in-memory pool.
                if auth_mod._is_terminal_codex_oauth_refresh_error(exc):
                    ...
                    self._entries = [
                        ...
                        if not _is_device_code_source(item.source)
                    ]
