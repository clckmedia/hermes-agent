...
class TestLoadGatewayConfig:
    ...
    def test_bridges_discord_skill_slash_commands_from_config_yaml(self, tmp_path, monkeypatch):
        hermes_home = tmp_path / ".hermes"
        hermes_home.mkdir()
        config_path = hermes_home / "config.yaml"
        config_path.write_text(
            "discord:\n"
            "  skill_slash_commands: false\n",
            encoding="utf-8",
        )
        ...
        assert config.platforms[Platform.DISCORD].extra["skill_slash_commands"] is False
