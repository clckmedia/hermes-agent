...
class TestThreadReplyHandling:
    ...
    @pytest.mark.asyncio
    async def test_thread_reply_without_mention_with_session_still_requires_mention(
        self, adapter_with_session_store, mock_session_store
    ):
        """Thread replies outside free-response channels require a fresh mention even with a session."""
