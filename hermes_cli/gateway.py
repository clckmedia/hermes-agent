...
_PLATFORMS = [
    ...
    },
    {
        ...
        "label": "Zulip",
        "emoji": "💬",
        "token_var": "ZULIP_BOT_API_KEY",
        "setup_instructions": [
            "1. Create or choose a Zulip bot account for chat messages",
            "2. Copy the Zulip site URL, bot email, and bot API key",
            "3. Optional: set ZULIP_ALLOWED_USERS to restrict who can use Hermes",
            "4. Default is DM-only; set ZULIP_DM_ONLY=false only after channel/topic testing",
        ],
        "vars": [
            {"name": "ZULIP_SITE", "prompt": "Zulip site URL (e.g. https://example.zulipchat.com)", "password": False,
             "help": "Your Zulip organization URL without a trailing slash."},
            {"name": "ZULIP_BOT_EMAIL", "prompt": "Bot email", "password": False,
             "help": "The Zulip bot account email."},
            {"name": "ZULIP_BOT_API_KEY", "prompt": "Bot API key", "password": True,
             "help": "The API key from the bot account settings."},
            {"name": "ZULIP_ALLOWED_USERS", "prompt": "Allowed user emails (comma-separated)", "password": False,
             "is_allowlist": True,
             "help": "Optional — restrict access to specific Zulip user emails."},
            {"name": "ZULIP_HOME_CHANNEL", "prompt": "Home target (e.g. dm:user@example.com)", "password": False,
             "help": "Optional target for cron and notifications."},
        ],
    },
    {
        "key": "matrix",
