...
async def build_channel_directory(adapters: Dict[Any, Any]) -> Dict[str, Any]:
    ...
    # discovery automatically.  Skip infrastructure entries and inactive Discord
    # history: Discord is fully enumerated above when an adapter is actually
    # connected, but old Discord sessions should not keep a platform directory
    # alive after a workspace migration.
