...
# Slack conversation IDs start with C (public channel), G (private channel/MPIM),
# or D (DM). Optional thread refs use Slack's ``channel_id:thread_ts`` form.
_SLACK_TARGET_RE = re.compile(r"^\s*([CGD][A-Z0-9]+)(?::(\d+\.\d+))?\s*$")
