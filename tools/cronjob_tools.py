...
def _format_job(job: Dict[str, Any]) -> Dict[str, Any]:
    ...
    result = {
        ...
        "last_agent_status": job.get("last_agent_status"),
        "last_script_status": job.get("last_script_status"),
        "last_script_error": job.get("last_script_error"),
